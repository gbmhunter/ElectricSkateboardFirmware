...
int main(void)
{
	...
	int char_start = 0; // Character that the display starts with
	int char_actual = 0; // Maybe current or next character
	int col_num = 0; // Column of text matrix to display, if greater than 5, displays start of next character
	int col_on = 0; // Column on LED matrix to turn on
	int position = 0; // Counts down to the next character
	int count = 0; // Controls speed of scrolling
