...
// Number of state cycles before comms has time out if no packet has arrived (16-bit). Make sure this is greater than COMMS_SEND_CYCLES
#define COMMS_TIMEOUT_PERIOD 5000
// Number of state cycles between each comms packet is sent (16-bit)
