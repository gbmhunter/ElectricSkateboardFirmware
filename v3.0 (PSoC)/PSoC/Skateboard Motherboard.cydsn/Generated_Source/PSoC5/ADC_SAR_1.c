...
volatile int16 ADC_SAR_1_countsPerVolt;   /* Gain compensation */
volatile int16 ADC_SAR_1_shift;
#if(CY_PSOC5_ES1)
    uint8 ADC_SAR_1_resolution;
...
void ADC_SAR_1_Enable(void)
{
    ...
    #elif(ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VSSA_TO_VDDA)
        ADC_SAR_1_SAR_CSR3_REG = ADC_SAR_1_SAR_EN_RESVDA_EN;     /* Set bit for VDD/2 mode */
        ADC_SAR_1_SetRef(ADC_SAR_1__VSSA_TO_VDDA);
    #elif(ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VSSA_TO_VDAC)
        ADC_SAR_1_SetRef(ADC_SAR_1_DEFAULT_RANGE);
    #elif(ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VREF_DIFF)
        ADC_SAR_1_SAR_CSR3_REG = ADC_SAR_1_SAR_EN_CP_EN;         /* Enable charge pump*/
        ADC_SAR_1_SetRef(ADC_SAR_1_DEFAULT_RANGE);
    #elif(ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDDA_DIFF)
        ADC_SAR_1_SAR_CSR3_REG = ADC_SAR_1_SAR_EN_CP_EN;         /* Enable charge pump*/
        ADC_SAR_1_SetRef(ADC_SAR_1__VSSA_TO_VDDA);
    #elif(ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDDA_2_DIFF)
        ADC_SAR_1_SAR_CSR3_REG = ADC_SAR_1_SAR_EN_RESVDA_EN |    /* Set bit for VDD/2 mode*/
                                        ADC_SAR_1_SAR_EN_CP_EN;         /* Enable charge pump*/
        ADC_SAR_1_SetRef(ADC_SAR_1__VSSA_TO_VDDA);
    #elif(ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDAC_DIFF)
        ADC_SAR_1_SetRef(ADC_SAR_1_DEFAULT_RANGE);
    ...
    #endif /* End ADC_SAR_1_DEFAULT_REFERENCE != ADC_SAR_1__EXT_REF */    
    /*Set Convertion mode */
    #if(ADC_SAR_1_DEFAULT_CONV_MODE == ADC_SAR_1__TRIGGERED)      /* If triggered mode */
...
void ADC_SAR_1_SetRef(int8 refMode)
{
    ...
    if(refMode == ADC_SAR_1__VSSA_TO_VDDA)
    {
            ...
            ADC_SAR_1_SAR_CSR3_REG |= ADC_SAR_1_SAR_EN_BUF_VREF_EN; /* Enable Int Ref Amp*/
        #elif(ADC_SAR_1_DEFAULT_REFERENCE == ADC_SAR_1__INT_REF_BYPASS)
            tmpReg = ADC_SAR_1_SAR_REF_S2_LSB_EN | ADC_SAR_1_SAR_REF_S3_LSB_EN | 
                     ADC_SAR_1_SAR_REF_S4_LSB_EN;
            ADC_SAR_1_SAR_CSR3_REG |= ADC_SAR_1_SAR_EN_BUF_VREF_EN; /* Enable Int Ref Amp*/
        #elif(ADC_SAR_1_DEFAULT_REFERENCE == ADC_SAR_1__EXT_REF)
            tmpReg = ADC_SAR_1_SAR_REF_S2_LSB_EN;
            ADC_SAR_1_SAR_CSR3_REG &= ~ADC_SAR_1_SAR_EN_BUF_VREF_EN; /* Disable Int Ref Amp*/
        #endif /*  End ADC_SAR_1_DEFAULT_REFERENCE */
    }
    else
    {
        #if(ADC_SAR_1_DEFAULT_REFERENCE == ADC_SAR_1__INT_REF_NOT_BYPASSED)
    ...
    ADC_SAR_1_SAR_CSR6_REG = tmpReg;
    ADC_SAR_1_SAR_CSR7_REG = ADC_SAR_1_SAR_REF_S_MSB_DIS;
}
...
void ADC_SAR_1_Stop(void)
{
    ...
    ADC_SAR_1_SAR_CSR0_REG &= ~ADC_SAR_1_SAR_SOF_START_CONV;
        ...
        ADC_SAR_1_SAR_CSR0_REG |= ADC_SAR_1_ICONT_LV_3;
        /* Disable reference buffer and reduce the reference power to the minimum */
        ADC_SAR_1_SAR_CSR3_REG = ADC_SAR_1_SAR_PWR_CTRL_VREF_DIV_BY4;    
    #else    
        ...
        ADC_SAR_1_SAR_CSR3_REG = ADC_SAR_1_SAR_EN_BUF_VREF_DIS;    
    #endif /* End CY_PSOC5_ES1 */
...
void ADC_SAR_1_SetPower(uint8 power)
{
    ...
    /* Set Power parameter  */
    tmpReg = ADC_SAR_1_SAR_CSR0_REG & ~ADC_SAR_1_SAR_POWER_MASK;
...
void ADC_SAR_1_SetResolution(uint8 resolution)
{
    ...
    switch (resolution)
    {
     ...
     tmpReg |= ADC_SAR_1_SAR_SAMPLE_WIDTH;   /* 18 conversion cycles @ 12bits + 1 gap*/
...
{
    #if(ADC_SAR_1_DEFAULT_CONV_MODE == ADC_SAR_1__TRIGGERED)   /* If triggered mode */
        ADC_SAR_1_SAR_CSR0_REG &= ~ADC_SAR_1_SAR_MX_SOF_UDB;   /* source: SOF bit */
...
*
* Global Variables:
*  ADC_SAR_1_shift - used to convert the ADC counts to the 2's 
*  compliment form.
*  ADC_SAR_1_resolution – used to shift the results for lower 
*   resolution.
*
*******************************************************************************/
int8 ADC_SAR_1_GetResult8( void )
{
        ...
        res = CY_GET_REG16(ADC_SAR_1_SAR_WRK0_PTR) - ADC_SAR_1_shift;
        
        /* Use 12bits for PSoC5 production silicon and shift the results for lower resolution in this API */
        if(ADC_SAR_1_resolution == ADC_SAR_1__BITS_10)
        {
            res >>= 2u;
        }
        else if(ADC_SAR_1_resolution == ADC_SAR_1__BITS_8)
        {
            res >>= 4u;
        }
    ...
    #else
        return( ADC_SAR_1_SAR_WRK0_REG - (int8)ADC_SAR_1_shift);
    #endif /* End CY_PSOC5_ES1 */
...
void ADC_SAR_1_CalcGain( uint8 resolution )
{
    uint32 counts = ADC_SAR_1_SAR_WRK_MAX;       /*default 12 bits*/
    uint16 diff_zero = ADC_SAR_1_SAR_DIFF_SHIFT;
...
*
* Global Variables:
*  ADC_SAR_1_countsPerVolt variable modified. This variable is used 
*  for gain calibration purpose. 
*
*******************************************************************************/
...
*  ADC_SAR_1_countsPerVolt variable used.
*
*******************************************************************************/
...
int32 ADC_SAR_1_CountsTo_uVolts(int16 adcCounts)
{
    ...
    */
    uVolts = (( (int32)adcCounts * 500000 ) / ADC_SAR_1_countsPerVolt) * 2;
...
*
*******************************************************************************/
float ADC_SAR_1_CountsTo_Volts(int16 adcCounts)
{
    float volts;
    ...
    volts = (float)adcCounts / (float)ADC_SAR_1_countsPerVolt;   
