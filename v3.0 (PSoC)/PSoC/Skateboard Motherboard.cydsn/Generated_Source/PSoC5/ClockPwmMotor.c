...
/*******************************************************************************
* Function Name: ClockPwmMotor_Start
********************************************************************************
* Summary:
...
void ClockPwmMotor_Start(void) 
{
    ...
    ClockPwmMotor_CLKEN |= ClockPwmMotor_CLKEN_MASK;
}


/*******************************************************************************
* Function Name: ClockPwmMotor_Stop
********************************************************************************
* Summary:
...
void ClockPwmMotor_Stop(void) 
{
	...
	CYDEV_CHIP_REVISION_USED == CYDEV_CHIP_REVISION_5A_ES1))
/*******************************************************************************
* Function Name: ClockPwmMotor_StopBlock
********************************************************************************
* Summary:
...
{
    if (ClockPwmMotor_CLKEN & ClockPwmMotor_CLKEN_MASK)
    {
        ...
        CLK_DIST_AMASK = ClockPwmMotor_CLKEN_MASK;
        CLK_DIST_DMASK = 0x00u;
#else
        CLK_DIST_DMASK = ClockPwmMotor_CLKEN_MASK;
        ...
        oldDivider = CY_GET_REG16(ClockPwmMotor_DIV_PTR);
        ...
        CLK_DIST_LD = 0x00u;
        CY_SET_REG16(ClockPwmMotor_DIV_PTR, oldDivider);
#endif
    }
}
#endif
...
/*******************************************************************************
* Function Name: ClockPwmMotor_StandbyPower
********************************************************************************
* Summary:
...
void ClockPwmMotor_StandbyPower(uint8 state) 
{
    if(state == 0)
    {
        ClockPwmMotor_CLKSTBY &= ~ClockPwmMotor_CLKSTBY_MASK;
    }
    else
    {
        ClockPwmMotor_CLKSTBY |= ClockPwmMotor_CLKSTBY_MASK;
...
/*******************************************************************************
* Function Name: ClockPwmMotor_SetDividerRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ClockPwmMotor_SetDividerRegister(uint16 clkDivider, uint8 restart) 
{
    uint8 enabled;

    uint8 currSrc = ClockPwmMotor_GetSourceRegister();
    uint16 oldDivider = ClockPwmMotor_GetDividerRegister();

    if (clkDivider != oldDivider)
    {
        enabled = ClockPwmMotor_CLKEN & ClockPwmMotor_CLKEN_MASK;
        ...
        if (currSrc == CYCLK_SRC_SEL_CLK_SYNC_D && (oldDivider == 0 || clkDivider == 0))
        {
            ...
            if (oldDivider == 0 && clkDivider != 0)
            {
                ...
                CY_SET_REG16(ClockPwmMotor_DIV_PTR, clkDivider);
                ClockPwmMotor_MOD_SRC &= ~CYCLK_SSS;
            }
            else
            {
...
/*******************************************************************************
* Function Name: ClockPwmMotor_GetDividerRegister
********************************************************************************
* Summary:
...
{
    return CY_GET_REG16(ClockPwmMotor_DIV_PTR);
}


/*******************************************************************************
* Function Name: ClockPwmMotor_SetModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ClockPwmMotor_SetModeRegister(uint8 clkMode) 
{
    ClockPwmMotor_MOD_SRC |= clkMode & ClockPwmMotor_MODE_MASK;
}


/*******************************************************************************
* Function Name: ClockPwmMotor_ClearModeRegister
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void ClockPwmMotor_ClearModeRegister(uint8 clkMode) 
{
    ClockPwmMotor_MOD_SRC &= ~clkMode | ~ClockPwmMotor_MODE_MASK;
}
...
/*******************************************************************************
* Function Name: ClockPwmMotor_GetModeRegister
********************************************************************************
* Summary:
...
{
    return ClockPwmMotor_MOD_SRC & ClockPwmMotor_MODE_MASK;
}


/*******************************************************************************
* Function Name: ClockPwmMotor_SetSourceRegister
********************************************************************************
* Summary:
...
{
    uint16 currDiv = ClockPwmMotor_GetDividerRegister();
    uint8 oldSrc = ClockPwmMotor_GetSourceRegister();
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        ClockPwmMotor_MOD_SRC |= CYCLK_SSS;
        ClockPwmMotor_MOD_SRC =
            (ClockPwmMotor_MOD_SRC & ~ClockPwmMotor_SRC_SEL_MSK) | clkSource;
    }
...
/*******************************************************************************
* Function Name: ClockPwmMotor_GetSourceRegister
********************************************************************************
* Summary:
...
{
    return ClockPwmMotor_MOD_SRC & ClockPwmMotor_SRC_SEL_MSK;
}
...
/*******************************************************************************
* Function Name: ClockPwmMotor_SetPhaseRegister
********************************************************************************
* Summary:
...
{
    ClockPwmMotor_PHASE = clkPhase & ClockPwmMotor_PHASE_MASK;
}


/*******************************************************************************
* Function Name: ClockPwmMotor_GetPhase
********************************************************************************
* Summary:
...
{
    return ClockPwmMotor_PHASE & ClockPwmMotor_PHASE_MASK;
}
