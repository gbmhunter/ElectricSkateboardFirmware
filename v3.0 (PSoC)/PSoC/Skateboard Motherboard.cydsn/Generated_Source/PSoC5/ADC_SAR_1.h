...
typedef struct _ADC_SAR_1_BackupStruct
{
    uint8 enableState;
...
#define ADC_SAR_1_MAX_FREQUENCY              (14000000u)       /*14Mhz*/
...
#define ADC_SAR_1_DEFAULT_REF_VOLTAGE (((ADC_SAR_1_DEFAULT_REFERENCE != ADC_SAR_1__EXT_REF) && \
                                        ((ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VSSA_TO_VDDA) || \
                                        (ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDDA_2_DIFF))) ? \
                                        (CYDEV_VDDA / 2) : \
                                        ((ADC_SAR_1_DEFAULT_REFERENCE != ADC_SAR_1__EXT_REF) && \
                                        (ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDDA_2_DIFF)) ? \
                                        CYDEV_VDDA : (1.024))      /* ADC reference voltage. */
#define ADC_SAR_1_DEFAULT_REF_VOLTAGE_MV (((ADC_SAR_1_DEFAULT_REFERENCE != ADC_SAR_1__EXT_REF) &&\
                                        ((ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VSSA_TO_VDDA) || \
                                        (ADC_SAR_1_DEFAULT_RANGE == ADC_SAR_1__VNEG_VDDA_2_DIFF))) ? \
                                        (CYDEV_VDDA_MV / 2) : \
                                        ((ADC_SAR_1_DEFAULT_REFERENCE != ADC_SAR_1__EXT_REF) && \
...
#define ADC_SAR_1_DEFAULT_POWER  ((1 != ADC_SAR_1__INTERNAL) ? ADC_SAR_1__HIGHPOWER : \
                      (1710000 > (ADC_SAR_1_MAX_FREQUENCY / 2)) ? ADC_SAR_1__HIGHPOWER : \
                      (1710000 > (ADC_SAR_1_MAX_FREQUENCY / 3)) ? ADC_SAR_1__MEDPOWER : \
                      (1710000 > (ADC_SAR_1_MAX_FREQUENCY / 4)) ? ADC_SAR_1__LOWPOWER : \
                                                                                        ADC_SAR_1__MINPOWER)
/* Constant for a global usage */
#define ADC_SAR_1_SAMPLE_PRECHARGE       (7) /* Number of additional clocks for sampling data*/
...
#define ADC_SAR_1_ACT_PWR_SAR_EN             ADC_SAR_1_ADC_SAR__PM_ACT_MSK 

/* PM_STBY_CFG (Alternate Active Power Mode CFG Register) Power enable mask */
#define ADC_SAR_1_STBY_PWR_SAR_EN            ADC_SAR_1_ADC_SAR__PM_STBY_MSK 
...
/* This is only valid if there is an internal clock */
    ...
    #define ADC_SAR_1_STBY_PWR_CLK_EN        ADC_SAR_1_theACLK__PM_STBY_MSK
#endif /*End ADC_SAR_1_DEFAULT_INTERNAL_CLK */
