...
{
    /* Set pins drive mode */
    CyPins_SetPinDriveMode(CapSense_PortCH0__ButtonMotorOnOff__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__ButtonLightsOnOff__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__ButtonAlarmOnOff__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__ButtonLightMode__BTN, mode);
