...
/* Define Sensors */
#define CapSense_SENSOR_BUTTONMOTORONOFF__BTN    (0u)
#define CapSense_SENSOR_BUTTONLIGHTSONOFF__BTN    (1u)
#define CapSense_SENSOR_BUTTONALARMONOFF__BTN    (2u)
#define CapSense_SENSOR_BUTTONLIGHTMODE__BTN    (3u)
