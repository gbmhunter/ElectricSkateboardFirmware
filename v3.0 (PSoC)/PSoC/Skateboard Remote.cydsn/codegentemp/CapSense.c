...
uint8 CYXDATA * const CYCODE CapSense_pcTable[] = {
    (uint8 CYXDATA *)CapSense_PortCH0__ButtonMotorOnOff__BTN__PC, 
    (uint8 CYXDATA *)CapSense_PortCH0__ButtonLightsOnOff__BTN__PC, 
    (uint8 CYXDATA *)CapSense_PortCH0__ButtonAlarmOnOff__BTN__PC, 
    (uint8 CYXDATA *)CapSense_PortCH0__ButtonLightMode__BTN__PC, 
};

const uint8 CYCODE CapSense_portTable[] = {
    CapSense_PortCH0__ButtonMotorOnOff__BTN__PORT, 
    CapSense_PortCH0__ButtonLightsOnOff__BTN__PORT, 
    CapSense_PortCH0__ButtonAlarmOnOff__BTN__PORT, 
    CapSense_PortCH0__ButtonLightMode__BTN__PORT, 
};

const uint8 CYCODE CapSense_maskTable[] = {
    CapSense_PortCH0__ButtonMotorOnOff__BTN__MASK,
    CapSense_PortCH0__ButtonLightsOnOff__BTN__MASK,
    CapSense_PortCH0__ButtonAlarmOnOff__BTN__MASK,
    CapSense_PortCH0__ButtonLightMode__BTN__MASK,
};
...
const uint8 CYCODE CapSense_widgetNumber[] = {
    0u, /* ButtonMotorOnOff__BTN */
    1u, /* ButtonLightsOnOff__BTN */
    2u, /* ButtonAlarmOnOff__BTN */
    3u, /* ButtonLightMode__BTN */
