...
#if (Timer_1_UsingFixedFunction)
    #define Timer_1_INIT_INTERRUPT_MODE ((0u << Timer_1_STATUS_TC_INT_MASK_SHIFT) | \
...
***************************************/
    ...
    ***************************************/
    ...
    #define Timer_1_STATUS              (* (reg8 *) Timer_1_TimerUDB_nrstSts_stsreg__STATUS_REG )
    #define Timer_1_STATUS_MASK         (* (reg8 *) Timer_1_TimerUDB_nrstSts_stsreg__MASK_REG)
