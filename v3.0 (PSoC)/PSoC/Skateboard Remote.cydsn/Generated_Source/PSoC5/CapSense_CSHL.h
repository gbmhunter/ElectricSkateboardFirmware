...
#define CapSense_BUTTONMOTORONOFF__BTN        (0u)
#define CapSense_BUTTONLIGHTSONOFF__BTN        (1u)
#define CapSense_BUTTONALARMONOFF__BTN        (2u)
#define CapSense_BUTTONLIGHTMODE__BTN        (3u)
